...
class ControladorFuncionario:
    ...
    def cadastrar_funcionario(self, usuario, senha, nome, cpf, data_nascimento, email, conta_bancaria, carga_horaria, salario, funcao: Funcao, msg=None):
        try:
